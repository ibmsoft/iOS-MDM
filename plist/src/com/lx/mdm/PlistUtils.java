...
public class PlistUtils {
	public static void main(String[] args) throws Exception {
		...
		PlistUtils test = new PlistUtils();
	...
	{
		String alias = "mdm";//Change to your alias
		String password = "Pansoft66778899";//Change to your password
